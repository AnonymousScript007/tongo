...
import (
	...
	"github.com/ice-hermes/tongo/abi/parser"
)
...
func main() {
	...
	for _, f := range [][]string{
		{types, "types.go", `"github.com/ice-hermes/tongo/tlb"`, `"fmt"`, `"encoding/json"`},
		{msgDecoder, "messages_generated.go", `"github.com/ice-hermes/tongo/tlb"`},
		{getMethods, "get_methods.go", `"context"`, `"fmt"`, `"github.com/ice-hermes/tongo/ton"`, `"github.com/ice-hermes/tongo/boc"`, `"github.com/ice-hermes/tongo/tlb"`},
		{invocationOrder, "interfaces.go", `"github.com/ice-hermes/tongo/ton"`},
		{jettons, "jetton_msg_types.go", `"github.com/ice-hermes/tongo/boc"`, `"github.com/ice-hermes/tongo/tlb"`},
		{nfts, "nfts_msg_types.go", `"github.com/ice-hermes/tongo/boc"`, `"github.com/ice-hermes/tongo/tlb"`},
